...
const cssBundles = {
  ...
  'page-books.css': ['core', 'collectionLayout', 'collectionSidebar', 'collectionHeader', 'collectionTasteCards', 'tasteSidebar', 'books'],
  'page-movies.css': ['core', 'collectionLayout', 'collectionSidebar', 'collectionHeader', 'collectionTasteCards', 'tasteSidebar', 'movies', 'moviesExtras'],
