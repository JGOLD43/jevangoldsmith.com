...
async function loadPeopleCards() {
    ...
    // Phase 1 slice 1.3: SSR'd cards (12 from people.json) stay in place.
    // For each merged person, reuse the existing SSR'd card if its
    // data-person-id matches; otherwise build a fresh card and APPEND.
    // This eliminates the wipe-and-replace CLS hit.
