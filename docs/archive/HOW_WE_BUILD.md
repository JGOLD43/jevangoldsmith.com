...
- `site-astro/src/pages/`, `site-astro/src/layouts/`, and `site-astro/src/partials/`
- `css/src/`
- `js/`
- `scripts/`
- `docs/`
...
- `robots.txt`
- `llms.txt`
- public `.html` files in `dist/` generated from `site-astro/src/pages/` or collection
  data
...
`site-astro/src/pages/`. `data/source-ownership.json` remains the contract for route
